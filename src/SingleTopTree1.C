...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../TTChannel_Synch6.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../TTChannel_Synch6.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../TTChannel_Synch6.root:/DMTreesDumper");
