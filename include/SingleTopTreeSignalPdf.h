...
// Mon Aug 31 17:07:29 2015 by ROOT version 6.02/05
// from TTree ttDM__noSyst/ttDM__noSyst
// found on file: /cmsdata2/STEA/signal_pdfWeights/maryamTest_1.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/cmsdata2/STEA/signal_pdfWeights/maryamTest_1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/cmsdata2/STEA/signal_pdfWeights/maryamTest_1.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/cmsdata2/STEA/signal_pdfWeights/maryamTest_1.root:/DMTreesDumper");
